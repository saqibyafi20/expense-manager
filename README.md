...
### Features
* Add daily expense records<br>
* View all recorded expenses<br>
* Category-wise expense summary<br>
* Monthly expense analysis<br>
* Budget limit comparison with alerts<br>
* File-based permanent data storage<br>
